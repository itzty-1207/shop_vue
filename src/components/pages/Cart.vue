...
import {toMoney} from '@/filter/moneyFilter.js'
    export default {
        ...
        methods: {
            //得到购物车的商品
            getCartInfo() {                
                if(localStorage.cartInfo){              //判断localStorage里是否有购物车数据      
                    this.cartInfo = JSON.parse(localStorage.cartInfo)   //如果有数据，我们去除并赋值给cartInfo
                }                
                console.log(' this.cartInfo:'+JSON.stringify(this.cartInfo))    //打印到控制台查看效果
